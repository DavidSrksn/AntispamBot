...
- Любые ссылки на СТОРОННИЕ Telegram-каналы, чаты, боты (t.me/...) — даже если подаются как «полезный совет» или «рекомендация»
- Продвижение сомнительных сервисов: крипта, трейдинг, ставки, казино, схемы заработка
- Сообщение, состоящее ТОЛЬКО из ссылки (без текста, комментария или контекста)
