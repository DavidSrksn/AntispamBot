...
PROMPT_TEMPLATE = """Ты — модератор Telegram-канала. Определи, является ли комментарий спамом.
...
## Что считать спамом
- Реклама: ссылки на каналы/чаты/боты, t.me ссылки, упоминания @каналов
- Продвижение услуг: крипта, трейдинг, ставки, заработок, инвестиции, казино
- Массовые рассылки: копипаст, бессмысленный текст для привлечения к профилю

## Что НЕ спам
- Обычные комментарии по теме канала, даже короткие
- Мнения, вопросы, благодарности
- Упоминание собственного опыта без рекламных ссылок
