...
- Ссылки на Telegram-каналы, похожих на мошенничество: крипта, трейдинг, ставки, казино, - чаты, боты (t.me/...) с призывом переходить или подписываться
- Продвижение сомнительных сервисов: крипта, трейдинг, ставки, казино, схемы заработка
- Продвижение телеграм ботов со ссылкой на бота или канал, исключение - @yamarketaffbot

## Что НЕ спам (важно!)
- Любое продвижение без ссылки на что-то
- просто ссылка без сопроводительного текста
...
Если сомневаешься — это НЕ спам.

Ответь СТРОГО JSON без пояснений:
{{"spam": true/false, "confidence": 0.0-1.0, "reason": "краткая причина на русском"}}

confidence — это уверенность, что сообщение ЯВЛЯЕТСЯ спамом. Если spam=false, confidence должен быть низким (0.0-0.3)."""
...
async def handle_comment(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_spam or confidence < SPAM_THRESHOLD:
        return
