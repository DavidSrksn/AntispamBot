...
2. Эта ссылка ведёт на СТОРОННИЙ ресурс с явным призывом перейти, подписаться или воспользоваться (крипта, трейдинг, ставки, казино, сторонние боты и каналы)
...
- Упоминание крипты, трейдинга, ставок — БЕЗ ссылки и без призыва
