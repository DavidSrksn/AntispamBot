...
- Сообщение, состоящее ТОЛЬКО из ссылки (без текста, комментария или контекста) — это спам-реклама

## Что НЕ спам (важно!)
- Ссылки С сопроводительным текстом (мнение, вопрос, сравнение) без упоминания сомнительного заработка, ставок, крипты, казино
